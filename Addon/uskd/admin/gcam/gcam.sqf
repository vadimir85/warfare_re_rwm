...
// titleText ["W, A, S, D, Q, Z, 2, X : Camera Move","PLAIN DOWN"]; titleFadeOut 3
// titleText ["","PLAIN DOWN"]; titleFadeOut 3

//////////////////////////////////////////////////////////////////
_starL  = "<img image='uskd\pics\troj.paa' align='left'/>";
_starR  = "<img image='uskd\pics\troj.paa' align='right'/>";
_title  = "<t color='#24c141' size='1.5' shadow='1.5' shadowColor='#000000' align='center'>GCam Hilfe...</t><br/><br/><br/>";
_text   = "<t color='#efefef' size='1' shadow='1' shadowColor='#000000' align='center'>*** Space = Quit ***<br/>- - -<br/>W, A, S, D, Q, Z, 2, X : Camera Move<br/>- - -<br/>Mouse Move, Drag (list opend) : Camera Turn<br/>- - -<br/>Mouse Wheel : Camera Zoom<br/>- - -<br/>Mouse L Click : Switch Screen Centered Unit<br/>- - -<br/>Mouse R Click : Zoom Default<br/>- - -<br/>L : Unit List and Search Map<br/>- - -<br/>N : Night / Thermal Vision<br/>- - -<br/>B : Toggle Behind Mode<br/>- - -<br/>F : Toggle Follow Mode<br/>- - -<br/>C : Toggle Focus Mode<br/>- - -<br/>T : Toggle Firing and Ejection Trigger<br/>- - -<br/>V : Change Camera View Mode</t>";
