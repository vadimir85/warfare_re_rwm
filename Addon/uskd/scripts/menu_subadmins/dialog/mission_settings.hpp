...
class MissionSettingsAdminTools {
	...
	onLoad = "[] execVM 'uskd\scripts\menu_subadmins\populate.sqf'";
	...
	class controls {
		...
		class AcceptButton : AdminTools_RscButton {
			...
			text = "anwenden";
			onButtonClick = "[] execVM 'uskd\scripts\menu_subadmins\apply_settings.sqf';";
