...
class MissionSettings {
	...
	onLoad = "[] execVM 'uskd\scripts\view_settings\populate.sqf'";
	...
	class controlsBackground {
		...
		class MainTitle : Sinky_RscText {
			...
			idc = -1;
			text = "Settings View Distance / Grass height";
	...
	class controls {
		...
		class AcceptButton : Sinky_RscButton {
			...
			text = "save";
			onButtonClick = "[] execVM 'uskd\scripts\view_settings\apply_settings.sqf';";
...
class MissionSettingsAdmins {
	...
	class controlsBackground {
		...
		class MainTitle : Sinky_RscText {
			...
			idc = -1;
			text = "Einstellungen Sichtweite / Grashöhe (Admins)";
