...
for [{_count = 0},{_count < 12},{_count = _count + 1}] do {CtrlSetText[_inventoryGUI + _count,"\rwm_core_ui\Images\gui\ui_gear_mag_gs.paa"]};
for [{_count = 0},{_count < 8},{_count = _count + 1}] do {CtrlSetText[_sidearmInvGUI + _count,"\rwm_core_ui\Images\gui\ui_gear_mag_gs.paa"]};
for [{_count = 0},{_count < 12},{_count = _count + 1}] do {CtrlSetText[_miscInvGUI + _count,"\rwm_core_ui\Images\gui\ui_gear_eq_gs.paa"]};
