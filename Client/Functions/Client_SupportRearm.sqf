...
if (_veh isKindOf 'StaticWeapon') then {_rearmTime = 300};
...
if (_veh isKindOf 'rhsgref_cdf_reg_BM21') then {_rearmTime = 445};
if (_veh isKindOf 'rhsgref_ins_BM21') then {_rearmTime = 445};
if (_veh isKindOf 'rhsgref_ins_g_BM21') then {_rearmTime = 445};
if (_veh isKindOf 'RHS_BM21_MSV_01') then {_rearmTime = 445};
if (_veh isKindOf 'RHS_BM21_VDV_01') then {_rearmTime = 445};
if (_veh isKindOf 'RHS_BM21_VMF_01') then {_rearmTime = 445};
if (_veh isKindOf 'RHS_BM21_VV_01') then {_rearmTime = 445};
if (_veh isKindOf 'rhs_2s3_tv') then {_rearmTime = 150};
if (_veh isKindOf 'rhsusf_m109d_usarmy') then {_rearmTime = 150};
if (_veh isKindOf 'rhsusf_m109_usarmy') then {_rearmTime = 150};
