...
switch (_type) do {
	...
	case "TownHintNew": {["TaskAssigned",[localize "str_taskNew",format [localize "STR_WF_CHAT_TaskTown_Display",_location getVariable "name"]]] call BIS_fnc_showNotification;};
	//--- Hint for a completed town task.
	case "TownHintDone": {["TaskSucceeded",[localize "str_taskAccomplished",format [localize "STR_WF_CHAT_TaskTown_Display",_location getVariable "name"]]] call BIS_fnc_showNotification;};
};