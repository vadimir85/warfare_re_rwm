...
["TaskAssigned", [localize "str_taskNew",Format[localize 'STR_WF_M_TOWN_Attack',_town getVariable "name"]]] call BIS_fnc_showNotification;
...
["TaskSucceeded",[localize "str_taskAccomplished",format [localize "STR_WF_M_TOWN_Attack",_town getVariable "name"]]] call BIS_fnc_showNotification;
{_x setMarkerColorLocal "ColorGreen"} forEach _markers;
