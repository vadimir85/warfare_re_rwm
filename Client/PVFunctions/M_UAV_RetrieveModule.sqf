...
["TaskAssigned",[localize "str_taskNew",localize 'STR_WF_M_UAV_RetrieveModule']] call BIS_fnc_showNotification;
...
if (_taskState == 'Succeeded') then {
	["TaskSucceeded", [localize "str_taskAccomplished",localize 'STR_WF_M_UAV_RetrieveModule']] call BIS_fnc_showNotification;	
} else {
	["TaskFailed", [localize "str_taskFailed",localize 'STR_WF_M_UAV_RetrieveModule']] call BIS_fnc_showNotification;
};
