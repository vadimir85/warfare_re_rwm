...
//--- West Allies.
['WFBE_WESTALLIESCREW','rhsgref_cdf_b_reg_crew',true] Call SetNamespace;
['WFBE_WESTALLIESSOLDIER','rhsgref_cdf_b_reg_rifleman',true] Call SetNamespace;
['WFBE_WESTALLIESPILOT','rhsgref_cdf_b_air_pilot',true] Call SetNamespace;
...
['WFBE_EASTALLIESSOLDIER','rhsgref_ins_rifleman',true] Call SetNamespace;
