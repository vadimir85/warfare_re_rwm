...
//M6
				...
				//Rearm TOR
				if (_vehicle isKindOf "ZSU23_TK") then {
					_vehicle setVariable ["mando_missilesleft0", 6, true];
				};
				
				//Rearm Rapier
				if (_vehicle isKindOf "rhsgref_cdf_b_zsu234") then {
					_vehicle setVariable ["mando_missilesleft0", 6, true];
				};
*/