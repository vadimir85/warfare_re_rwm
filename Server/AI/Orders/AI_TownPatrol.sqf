...
for [{_z=0},{_z<=_maxWaypoints},{_z=_z+1}] do {
	...
	diag_log Format["[WFRE (INFORMATION)][frameno:%4 | ticktime:%5] AI_TownPatrol: The %1 %2 Team is patrolling the %3 town",side _team,_team,_town,diag_frameno,diag_tickTime];
	};
