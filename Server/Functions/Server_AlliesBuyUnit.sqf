...
diag_log Format["[WFRE (INFORMATION)][frameno:%3 | ticktime:%4] Server_AlliesBuyUnit: AI Team %1 has purchased a '%2'",_team,_unitType,diag_frameno,diag_tickTime];
...
if (_unitType isKindOf "Man") then {
	...
	_vehicle = [_unitType,_position,_side,2] Call CreateVehi;
