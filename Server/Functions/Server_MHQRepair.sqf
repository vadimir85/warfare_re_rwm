...
//ok _MHQ setVehicleInit Format["['Headquarters','ColorGreen',[1,1],'','HQUndeployed',this,0.2,false,'','',false,%1] ExecVM 'Common\Common_MarkerUpdate.sqf';%2",_side,_text];
//ok _MHQ setVehicleInit Format["['Headquarters','ColorGreen',[1,1],'','HQUndeployed',this,0.2,true,'Headquarters','ColorOrange',true,%1] ExecVM 'Common\Common_MarkerUpdate.sqf';%2",_side,_text];
[[['n_hq','ColorGreen',[1,1],'','HQUndeployed',_MHQ,0.2,true,'n_hq','ColorOrange',true,_side], "Common\Common_MarkerUpdate.sqf"], "BIS_fnc_execVM", true, true] call BIS_fnc_MP;
//ProcessInitCommands;
deleteVehicle _hq;
...
diag_log Format["[WFRE (INFORMATION)][frameno:%2 | ticktime:%3] Server_MHQRepair: The %1 MHQ was repaired.",_sideText,diag_frameno,diag_tickTime];