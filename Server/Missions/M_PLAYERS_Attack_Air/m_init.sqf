...
_chopper = "I_Heli_light_03_unarmed_F";
...
//--- Man the chopper.
_pilot = ["I_C_Helipilot_F",_group,[0,0,0],resistance] Call CreateMan;
...
if (count _turrets > 0) then {[_turrets, [], _vehicle, "I_C_Soldier_Para_2_F", _group] call SpawnTurrets};
